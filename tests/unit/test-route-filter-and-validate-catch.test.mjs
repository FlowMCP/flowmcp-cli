...
// were removed together with FlowMcpCli.test. The route-filter behaviour now lives
// on "grading deterministic <namespace>/tool/<name>" (covered by
// grading-deterministic.test.mjs). The validate/list/callListTools blocks below
